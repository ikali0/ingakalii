      ...
      >
        <div className="flex items-center justify-between h-full px-3">
          ...
          <motion.button
            ...
            className="flex items-center gap-2 h-9 border font-[Segoe_UI] text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/40 bg-secondary border-solid text-center rounded-sm px-[12px] border-accent"
            whileTap={{
              y: 1,
            }}
          >
