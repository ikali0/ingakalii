...
const articles: BlogArticle[] = [{
  ...
  excerpt: "A critical examination of how fairness metrics can obscure rather than reveal ethical dimensions.",
  readTime: "8 min read",
  ...
  excerpt: "Why governance frameworks succeed or fail based on incentives and institutional power.",
  readTime: "7 min read",
  publishDate: "Jan 2025",
...
function ArticleCard({
  ...
  return <motion.a ref={ref} href={article.url} target="_blank" rel="noopener noreferrer" initial={{
    opacity: 0,
    y: 30
  }} animate={isInView ? {
    opacity: 1,
    ...
    scale: 0.99
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-md flex items-center justify-center bg-primary/10">
            <FontAwesomeIcon icon={article.icon} className="w-5 h-5 text-primary" />
          </div>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-border/40 text-xs text-muted-foreground">
        ...
        <span className="flex items-center gap-1 font-medium text-secondary-foreground">
          Read
...
export default function AIEthicsBlog() {
  return <section id="blog" className="relative py-section px-4 bg-background overflow-hidden text-secondary-foreground">
      <div className="absolute inset-0 opacity-10 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-muted/20 to-transparent" />
      </div>

      <div className="relative z-10 mx-auto max-w-3xl">
        <SectionHeader overline="Selected Writing" title="Research & Analysis" description="Long-form essays on AI ethics, governance, and algorithmic accountability." />
