              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <TimelineContent
                    ...
                    className="w-9 h-9 border border-border/50 bg-card/80 backdrop-blur-sm rounded-lg flex items-center justify-center hover:border-primary/50 hover:bg-primary/5 transition-colors"
                  >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <TimelineContent
                    ...
                    className="w-9 h-9 border border-border/50 bg-card/80 backdrop-blur-sm rounded-lg flex items-center justify-center hover:border-secondary/50 hover:bg-secondary/5 transition-colors"
                  >
        ...
        <div className="grid md:grid-cols-3 gap-10 md:gap-16">
          ...
          <div className="md:col-span-2">
            ...
            <TimelineContent
              ...
              timelineRef={sectionRef}
              customVariants={revealVariants}
              className="grid md:grid-cols-2 gap-6 text-foreground/80"
            >
              <TimelineContent
                as="div"
                animationNum={4}
            ...
            <TimelineContent
              ...
              timelineRef={sectionRef}
              customVariants={revealVariants}
              className="mt-6 text-sm md:text-base text-foreground/80 leading-relaxed max-w-xl"
            >
          ...
          <div className="md:col-span-1">
            <div className="md:text-right">
              <TimelineContent
                ...
                timelineRef={sectionRef}
                customVariants={revealVariants}
                className="text-accent text-2xl md:text-3xl font-bold mb-2"
              >
                INGA K.
              </TimelineContent>
              ...
              <TimelineContent
                ...
                timelineRef={sectionRef}
                customVariants={revealVariants}
                className="mb-6 flex md:flex-col gap-3 md:items-end"
              >
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-card border border-border/50 hover:border-foreground/20 transition-colors text-sm"
                      >
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-card border border-border/50 hover:border-[#FF6719]/30 transition-colors text-sm"
                      >
              ...
              <TimelineContent
                ...
                href="#contact"
                className="inline-flex md:ml-auto gap-2 hover:gap-3 items-center bg-foreground hover:bg-foreground/90 text-background px-5 py-3 rounded-lg cursor-pointer font-semibold text-sm transition-all duration-300 shadow-lg"
              >
                LET'S CONNECT
