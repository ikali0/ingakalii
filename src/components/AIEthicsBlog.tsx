...
function ArticleCard({ article }: ArticleCardProps) {
  return (
    <motion.a 
      ...
      className="group block border border-border/50 bg-card/50 backdrop-blur-sm rounded-lg p-6 
    ...
    <div className="container relative z-10 mx-auto max-w-3xl">
      <ScrollFade>
        <SectionHeader 
          ...
          description="Long-form essays on AI ethics, governance, and the systems that shape algorithmic accountability." 
        />
      </ScrollFade>
