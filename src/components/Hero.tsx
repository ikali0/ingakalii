      ...
      <div className="container relative z-20 mx-auto max-w-5xl flex flex-col items-center md:items-start text-center md:text-left">
        ...
        >
          ...
          <span className="relative inline-block">
            <span className="relative z-10 font-semibold text-foreground italic">policy into deployable controls</span>
        ...
        <TooltipProvider>
          <motion.div
            className="md:justify-start mb-container-lg flex items-start justify-center gap-3"
            initial={{
              opacity: 0,
              y: 30,
            }}
