...
const careerTimeline: TimelineEntry[] = [{
  ...
  highlights: ["Created ROI reports for budget allocations", "Improved operational efficiency by 25%", "Achieved 30% reduction in data retrieval time"],
  ...
  highlights: ["Optimized capital portfolios for DoD (30% improvement)", "Developed compliance frameworks with DLA", "Designed user-centric interfaces for energy.gov"],
...
const Experience = () => {
  ...
  return <section id="experience" className="relative py-section-sm md:py-section px-4 bg-muted/30 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto max-w-3xl">
        {/* Section Header */}
        <motion.div className="mb-container md:mb-container-lg" initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
        opacity: 1,
        ...
        <div className="relative">
          ...
          <div className="absolute left-3 md:left-1/2 top-0 bottom-0 w-0.5 md:-translate-x-1/2 rounded-full" style={{
          ...
          <div className="space-y-card-sm md:space-y-card">
            ...
            delay: index * 0.06
                ...
                <motion.div className={`absolute left-1.5 md:left-1/2 top-4 w-3 h-3 rounded-full md:-translate-x-1/2 z-10 ${getStatusStyles(exp.status)}`} style={{
              ...
              scale: 1.3
                ...
                {/* Connector Line */}
                <div className={`hidden md:block absolute top-card-sm w-card-sm h-px ${index % 2 === 0 ? "left-1/2 ml-element-sm" : "right-1/2 mr-element-sm"}`} style={{
              background: "hsl(var(--primary) / 0.3)"
            }} />

                {/* Card Container */}
                <div className={`md:w-[calc(50%-1.5rem)] ${index % 2 === 0 ? "md:ml-auto md:pl-card" : "md:mr-auto md:pr-card"}`}>
                  <motion.div className="relative glass rounded-lg overflow-hidden cursor-pointer" style={{
                    ...
                    <div className="p-card">
                      ...
                      <div className="flex items-center justify-between gap-element-sm mb-element-sm">
                        <div className="flex items-center gap-element-sm">
                          ...
                          <span className="text-caption font-small-text-primary">
                            {exp.period}
                          </span>
                        </div>
                      ...
                      {/* Expand Button */}
                      <button className="flex items-center gap-1 text-caption text-muted-foreground hover:text-foreground transition-colors mb-element" onClick={e => {
                    e.stopPropagation();
                    toggleExpand(index);
                  }}>
                      ...
                      <div className="flex-wrap flex items-start justify-center gap-element-sm">
                        {exp.tags.map(tag => <motion.div key={tag} whileHover={{
                      scale: 1.1
                    }}>
        ...
        <VerticalTimeline entries={careerTimeline} title="Career Journey" overline="Timeline" />
      </div>
    </section>;
};
